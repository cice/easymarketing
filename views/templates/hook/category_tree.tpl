...
<table cellspacing="0" cellpadding="0" class="table">
	...
	<tr class="{if $category.index % 2 == 0}alt_row{else}{/if}">
		...
		{for $i = 2 to $category.level|@count}
		    ...
		    <img  src="../modules/emarketing/views/img/lvl_{$category.has_suite[$i - 2]|escape:'htmlall':'UTF-8'}.gif" alt="" />
		{/for}
	
		<img src="../modules/emarketing/views/img/{if $category.level == 1}lv1.gif{else}lv2_{if $category.todo == $category.doneC}f{else}b{/if}.gif{/if}" alt="" /> &nbsp;
